...
<form action="{{ route('siswas.store') }}" method="POST" class="space-y-4">
    ...
    <div>
        ...
        <input type="date" name="tanggal_lahir" class="w-full border rounded" required>
    </div>
    ...
    <div>
        ...
        <input type="text" name="email" class="w-full border rounded" required>
    </div>

    <div>
        <label class="block">No Telepon</label>
        <input type="text" name="no_telepon" class="w-full border rounded" required>
    </div>
